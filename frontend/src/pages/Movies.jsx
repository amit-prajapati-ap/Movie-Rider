...
const Movies = () => {
  ...
  return dummyShowsData.length > 0 ? (
    <div className="px-4 md:px-6 lg:px-8 xl:px-44 overflow-hidden mx-auto my-30 relative">
      <h1 className='lg:text-4xl text-2xl font-semibold text-center my-12'>Now Showing</h1>
      <BlurCircle top='50px' left='50px'/>
      <BlurCircle bottom='50px' right='50px'/>
      <div className='flex flex-wrap max-md:justify-center gap-6 mx-auto w-full'>
